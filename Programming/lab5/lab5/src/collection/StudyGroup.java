...
public class StudyGroup implements Map.Entry<Integer, StudyGroup>, Comparable<StudyGroup> {
    ...
    public StudyGroup(int id, String name, Coordinates coordinates,java.util.Date creationDate,long studentsCount,int transferredStudents,long averageMark,Semester semesterEnum,Person groupAdmin) {
